...
max_rad=6900/60*2*pi;      %[rad/s]    system maximum rotational velocity

%% Vehicle chassis

%initial conditions
veh_V0=111*1000/3600;      %[m/s]      vehicle initial velocity
...
%intial conditions
clu_W0=eng_W0/60*2*pi;    %[rad/s]    clutch initial angular velocity

%simulation parameters
clu_engage=5;            %[s]         simulation time that clutch engagement begins (set to high value for coastdowns)
clu_posmax=183;           %[mm]        clutch pedal maximum travel

%parameters
n_max=6900;               %[rpm]       maximum engine rotational speed    
Jf=0.14+0.0295;           %[kgm^2]     flywheel and engine inertia
r_clu=0.1035;             %[m]         clutch mean radius
mu_k=0.82;                %[]          coefficient of dynamic friction
b_clu=0.01;               %[Nms/rad]   clutch viscous friction
clu_Fmax=21825;           %[N]         clutch maximum normal force


clu_Fn=[0 0 0 540 2131 5102 9580 12232 17101 18501 18538];      %[N]    clutch clamp force 
...
%parameters
Jfd=0.004;                       %[kg/m^2]       final drive inertia
